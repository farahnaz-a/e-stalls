        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="680" class="container"
            ...
            <tr>
                <td align="left" class="hero" style="padding:28px 40px 16px; background:#ffffff;">
                    ...
                    Een gebruiker met de naam {{ $cancel->name }} heeft een annuleringsverzoek ingediend. Beheerders willen graag dat u het verzoek controleert. U kunt het verzoek bekijken via uw dashboard.
                    </p>
                </td>
            </tr>
