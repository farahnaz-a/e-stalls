                ...
                <tr> 
                  ...
                  >
                    ...
                    <p
                      ...
                      "
                    >
                        Hieronder zie je de status van jouw veilingitems.
                        <br />
                        Zijn er items afgekeurd? Geen zorgen, je kunt ze eenvoudig aanpassen via je dashboard.
                        <br />
                        Alles goedgekeurd? Dan ben je helemaal klaar voor het event. 
                        <br />
                        Veel succes en we hopen op mooie biedingen!
                    </p> 
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; margin: 20px 0;">
                        <thead>
                            ...
                            <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Titel van veiling-item</th>
                            <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($vendor->getAllAuction as $item)
                                <tr style="border: 1px solid #ddd;">
                                    <td style="padding: 10px; border: 1px solid #ddd;">{{ $loop->iteration }}</td>
                                    <td style="padding: 10px; border: 1px solid #ddd;">{{ $item->name }}</td>
                                    <td style="padding: 10px; border: 1px solid #ddd; color: {{ $item->status == 'live' ? 'green':'red'  }};">{{ $item->status == 'live' ? 'Goedgekeurd':'Afgekeurd'  }}</td>
                                </tr> 
                            @endforeach
                            {{-- <tr style="border: 1px solid #ddd;">
