...
<head>
    ...
    <title>E-Stalls Events - Annuleringsverzoek</title>
...
<body style="margin:0; padding:0; background-color:#f3f2f0; font-family: 'Roboto', sans-serif, Arial, Helvetica;">
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="680" class="container"
            ...
            <tr>
                <td align="left" class="hero" style="padding:28px 40px 16px; background:#ffffff;">
                    <h2 style="margin:0 0 8px 0; font-size:18px; color:#3d3d3d; font-weight:700;">Beste Admin,</h2>
                    <p style="margin:0; font-size:15px; color:#4b5563; line-height:1.6;">
                       Een gebruiker met de naam {{ $cancel->name }} heeft een annuleringsverzoek ingediend. Belangrijke informatie vindt u op uw dashboard.
