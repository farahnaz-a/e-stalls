                ...
                <tr>
                  ...
                  >
                    ...
                    <p
                      ...
                      "
                    >
                    @if($data['type'] == 'AuctionApprove')
                        Uw veiling is succesvol geaccepteerd
                    @elseif ($data['type'] == 'AuctionDecline')
                        uw veiling is afgewezen
                    @elseif ($data['type'] == 'StallApprove')
                        Uw kraam is goedgekeurd
                    @elseif ($data['type'] == 'StallDecline')
                        Uw kraam verval
                    @endif
                    </p>
                  </td>
