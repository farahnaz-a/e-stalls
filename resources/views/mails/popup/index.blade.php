                ...
                <tr>
                  ...
                  >
                    <p
                      ...
                      "
                    >
                        Gefeliciteerd, jij hebt een prijs gewonnen! 🎉
                    </p>
                    ...
                    <p
                      style="font-size: 18px;
                        ...
                        padding-top: 34px;
                        line-height: 1.7;">
                        <strong>Belangrijke info over je prijs:</strong><br>
                        <strong>🏆 Je gewonnen prijs:</strong> <span>{{ $popup->price_name ?? "" }}</span><br>
                        <strong>📬 Je ontvangt je prijs binnenkort, digitaal of per post!</strong>
                        <br />
                    </p> 
