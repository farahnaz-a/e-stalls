...
@section('content')
    <div class="container w-container">
        ...
        <form method="get" action="{{ route('admin.cancel.list') }}">
            @csrf
    ...
    <div class="modal" id="assignVendorModal">
        <div class="modal-content">
            <form id="assignVendorForm" method="POST" action="{{ route('forward.vendor.cancel.request') }}">
                @csrf
...
@section('js')
  <script>
    ...
    <script>
        function getVendorsOfThisEvent(eventId, cancelId) {
            $.ajax({
                type: "GET",
                url: "{{ route('get.vendors.cancel') }}",
                data: {
                    'id': eventId,
                    'cancel_id': cancelId
                },
                ...
                success: (vendorArray) => {
                    ...
                    let cancelId = vendorArray.cancelId;
                    ...
                    <div class="vendor-radio">
                        ...
                        <input type="hidden" name="cancel_id" value="${cancelId}">
                    </div>
